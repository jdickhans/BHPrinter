...
(function () {
    ...
    var _labelData = { FirstName: "JIM", LastName: "DICKHANS", Major1: "BIT - IT Management", Major2: "", QRCode: "904423860" };
    ...
    function applyDataToLabel(label, labelData) {
        ...
        var major1 = getQueryParam('Major1');
        var major2 = getQueryParam('Major2');
        var qrCode = getQueryParam('QRCode');

        // Constructing the _labelData object
        var _labelData = {
            FirstName: firstName,
            LastName: lastName,
            Major1: major1,
        ...
        label.setObjectText('FirstName', _labelData['FirstName']);
        label.setObjectText('LastName', _labelData['LastName']);
        label.setObjectText('Major1', _labelData['Major1']);
        label.setObjectText('Major2', _labelData['Major2']);
        label.setObjectText('QRCode', _labelData['QRCode'])
        console.log(label._getObjectElements()[3]);
        console.log(dymo.label.framework.openLabelXml(label));
